...
export default function DashboardPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <MetricsGrid selectedDateRange={dateRange} searchQuery={searchQuery} selectedProgram={selectedProgram} selectedCohort={selectedCohort} />
      
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <ChartsSection selectedDateRange={dateRange} searchQuery={searchQuery} selectedProgram={selectedProgram} selectedCohort={selectedCohort}/>
