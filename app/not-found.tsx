...
export default function NotFound() {
  ...
  const stackTrace = new Error("Page Not Found").stack || "No stack trace available";
    ...
    // <Drawer>
      <div className="flex flex-col items-center justify-center h-screen text-center">
        ...
        <div className="space-y-4 mb-2 flex flex-col justify-center">
          ...
          <Button variant="link" className="flex gap-2 items-center text-base" onClick={() => router.back()}>
