...
export function ApplicationDetails({
  ...
  }, [application, applicationDetails, checkInterviewStatus]);
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            {interview ? (
                  ...
                  {applicationDetails?.applicationTestInterviews.map(
                    (interview: any, index: any) => (
                      ...
                      >
                        ...
                        {index !== 0 &&
                        interview?.meetingStatus === "Interview confirmed" ? (
                          <p className="capitalize">Int. Time Elapsed</p>
                        ) : index === 0 && status === "interview concluded" ? (
                          <p className="capitalize">Int. Time Elapsed</p>
                        ) : (
                          <p className="capitalize">
                            Interview fsf {interview?.meetingStatus}
                          </p>
                        )}
                      </div>
                    )
              ...
              <Select
                disabled={["initiated", "accepted", "rejected"].includes(
          ...
          {applicationDetails?.applicationTestInterviews?.[0]?.feedback.length >
            0 && (
            <>
              <Separator />
